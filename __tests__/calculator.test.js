...
describe("Calculator", () => {
  ...
  test("should provide a different return given age = life expectancy on Venus", () => {
    const newPerson = new Calculator(45.012, "other", "Japan")
    newPerson.earthExpectancy()
    newPerson.venusCalc()
    newPerson.yearsLeft()
    newPerson.venusReturnText()
    expect(newPerson.venusReturn).toEqual("Wow! You have exactly reached the average life expectancy for a person in your demographic categories on Venus!")
  })

  test("should provide a different return given age > life expectancy on Venus", () => {
    const newPerson = new Calculator(65, "other", "Japan")
    newPerson.earthExpectancy()
    newPerson.venusCalc()
    newPerson.yearsLeft()
    newPerson.venusReturnText()
  ...
  test("should provide a different return given age < life expectancy on Mars", () => {
    const newPerson = new Calculator(25, "prefer not to say", "France")
    newPerson.earthExpectancy()
    newPerson.marsCalc()
    newPerson.yearsLeft()
    newPerson.marsReturnText()
    expect(newPerson.marsReturn).toEqual("Hooray! The average life expectancy on Mars is still 59.3 years away for you!")
  })

  test("should provide a different return given age = life expectancy on Mars", () => {
    const newPerson = new Calculator(136.488, "prefer not to say", "France")
    newPerson.earthExpectancy()
    newPerson.marsCalc()
    newPerson.yearsLeft()
    newPerson.marsReturnText()
    expect(newPerson.marsReturn).toEqual("Wow! You have exactly reached the average life expectancy for a person in your demographic categories on Mars!")
  })

  test("should provide a different return given age > life expectancy on Mars", () => {
    const newPerson = new Calculator(150, "prefer not to say", "France")
    newPerson.earthExpectancy()
    newPerson.marsCalc()
    newPerson.yearsLeft()
    newPerson.marsReturnText()
  ...
  test("should provide a different return given age < life expectancy on Jupiter", () => {
    const newPerson = new Calculator(87, "female", "Egypt")
    newPerson.earthExpectancy()
    newPerson.jupiterCalc()
    newPerson.yearsLeft()
    newPerson.jupiterReturnText()
    expect(newPerson.jupiterReturn).toEqual("Hooray! The average life expectancy on Jupiter is still 67.9 years away for you!")
  })

  test("should provide a different return given age = life expectancy on Jupiter", () => {
    const newPerson = new Calculator(891.872, "female", "Egypt")
    newPerson.earthExpectancy()
    newPerson.jupiterCalc()
    newPerson.yearsLeft()
    newPerson.jupiterReturnText()
